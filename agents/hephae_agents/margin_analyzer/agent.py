...
from hephae_agents.margin_analyzer.prompts import (
...
from hephae_agents.margin_analyzer.tools import (
    benchmark_tool,
...
vision_intake_agent = LlmAgent(
    ...
    description="Extracts and parses menu items with prices from the menu image.",
...
benchmarker_agent = LlmAgent(
    ...
    model=AgentModels.PRIMARY_MODEL,
    description="Benchmarks menu item prices against local competitors.",
...
commodity_watchdog_agent = LlmAgent(
    ...
    model=AgentModels.PRIMARY_MODEL,
    description="Fetches current commodity and ingredient price trends.",
...
surgeon_agent = LlmAgent(
    name="SurgeonAgent",
    model=AgentModels.PRIMARY_MODEL,
    description="Identifies specific menu items where margin can be improved.",
...
advisor_agent = LlmAgent(
    name="AdvisorAgent",
    model=AgentModels.PRIMARY_MODEL,
    description="Synthesizes benchmarks, commodity trends, and surgical analysis into strategic recommendations.",
