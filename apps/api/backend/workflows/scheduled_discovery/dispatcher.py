...
def _make_capability_tools(
    ...
    async def run_seo_audit() -> str:
        ...
        try:
            from hephae_capabilities.seo_auditor.runner import run_seo_audit as _run
    ...
    async def run_traffic_forecast() -> str:
        ...
        try:
            from hephae_capabilities.traffic_forecaster.runner import run_traffic_forecast as _run
            result = await _run(identity)
            if result:
    ...
    async def run_competitive_analysis() -> str:
        ...
        try:
            from hephae_capabilities.competitive_analysis.runner import run_competitive_analysis as _run
            result = await _run(identity)
            if result:
    ...
    async def run_margin_analysis() -> str:
        ...
        try:
            from hephae_capabilities.margin_analyzer.runner import run_margin_analysis as _run
            result = await _run(identity)
            if result:
    ...
    async def run_social_media_audit() -> str:
        ...
        try:
            from hephae_capabilities.social.media_auditor.runner import run_social_media_audit as _run
            result = await _run(identity)
            if result:
