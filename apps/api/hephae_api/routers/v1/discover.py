...
from hephae_agents.discovery import LocatorAgent, discovery_pipeline
from hephae_common.firebase import get_db
from hephae_common.adk_helpers import user_msg
from hephae_api.types import EnrichedProfile, V1Response
...
async def v1_discover(request: Request):
    try:
        ...
        try:
            ...
            db_ref = get_db().collection("discovered_businesses").document(doc_id)
