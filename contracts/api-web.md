...
Both web and admin UIs proxy `/api/*` to this backend.
...
|------------|--------|---------------|-----------|
| SEO Audit | `hephae_capabilities.seo_auditor.runner` | `seo_auditor` | Yes |
| Traffic Forecast | `hephae_capabilities.traffic_forecaster.runner` | `traffic_forecaster` | Yes |
| Competitive Analysis | `hephae_capabilities.competitive_analysis.runner` | `competitive_analyzer` | Yes |
| Margin Surgery | `hephae_capabilities.margin_analyzer.runner` | `margin_surgeon` | Yes |
| Social Media Audit | `hephae_capabilities.social.media_auditor.runner` | `social_media_auditor` | No |
