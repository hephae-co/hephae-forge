...
#
# Usage:
#   bash infra/scripts/deploy-discovery-job.sh               # deploy job only
#   bash infra/scripts/deploy-discovery-job.sh --schedule    # deploy + scheduler
#   bash infra/scripts/deploy-discovery-job.sh --delete      # tear down all
#
# Scheduling:
...
JOB_FLAGS=(
    ...
    --command "python"
    --args "/app/apps/api/hephae_api/run_discovery_batch.py"
)
