...
#
# Usage:
#   bash infra/scripts/deploy-eval-job.sh             # create or update
#   bash infra/scripts/deploy-eval-job.sh --delete    # tear down the job
#
# After deploy, trigger with:
#   bash infra/scripts/trigger-evals.sh
# ──────────────────────────────────────────────────────────────
set -euo pipefail
...
echo ""
echo "Run all evals:           bash infra/scripts/trigger-evals.sh"
echo "Run a specific agent:    bash infra/scripts/trigger-evals.sh --agent seo_auditor"
echo "Run human-curated only:  bash infra/scripts/trigger-evals.sh --human-curated"
