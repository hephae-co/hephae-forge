"""Email sending via Resend — merged from web + admin.

Provides:
  - send_report_email: Branded report notification email (from web)
  - send_email: Generic email sending (from admin)
"""
...
def build_report_email_html(
    business_name: str, report_type: EmailReportType, report_url: str, summary: str,
) -> str:
...
async def send_report_email(
    to: str, business_name: str, report_type: EmailReportType,
    report_url: str, summary: str,
) -> dict:
    """Send a branded report email via Resend."""
    try:
