  ...
  <style>
    ...
    * {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    .card {{
      ...
      border: 2px solid rgba(255,255,255,0.2); border-radius: 28px;
      padding: 48px 56px;
    ...
    .logo-area img {{ height: 32px; filter: brightness(0) invert(1); opacity: 0.9; }}
    .logo-text {{ font-size: 18px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; opacity: 0.9; }}
    .badge {{ padding: 8px 20px; border-radius: 50px; background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.25); font-size: 13px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; }}
    .center {{ text-align: center; flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; }}
    .business-name {{ font-size: 42px; font-weight: 800; letter-spacing: -0.5px; margin-bottom: 16px; text-shadow: 0 2px 12px rgba(0,0,0,0.15); }}
    .headline {{ font-size: 72px; font-weight: 900; letter-spacing: -1px; line-height: 1; color: {accent}; text-shadow: 0 4px 20px rgba(0,0,0,0.2); }}
    .subtitle {{ font-size: 22px; font-weight: 600; margin-top: 8px; opacity: 0.85; letter-spacing: 0.5px; }}
    .bottom {{ display: flex; align-items: center; justify-content: center; }}
    .url {{ font-size: 16px; font-weight: 600; opacity: 0.6; letter-spacing: 1px; }}
  </style>
</head>
<body>
  <div class="card">
