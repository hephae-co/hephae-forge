...
class TestGenerateSocialPosts:
    ...
    async def test_returns_all_platforms(self):
        ...
        with (
            patch("hephae_agents.social.post_generator.agent.InMemorySessionService") as mock_svc_cls,
            patch("hephae_agents.social.post_generator.agent.Runner") as mock_runner_cls,
        ):
    ...
    async def test_social_handles_passed_to_context(self):
        ...
        from hephae_agents.social.post_generator.agent import _build_context
...
class TestBuildRichContext:
    ...
    def test_includes_business_name(self):
        from hephae_agents.social.post_generator.agent import _build_rich_context
...
class TestFallbackPosts:
    ...
    def test_contains_business_name(self):
        from hephae_agents.social.post_generator.agent import _fallback_posts
...
class TestParseJson:
    ...
    def test_plain_json(self):
        from hephae_agents.social.post_generator.agent import _parse_json
...
async def client():
    with patch(
        "hephae_api.routers.web.social_posts.generate_social_posts",
