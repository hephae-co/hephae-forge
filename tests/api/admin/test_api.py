...
pytest.skip(
    "Module paths changed during refactor — old admin backend targets "
    "(scan_zipcode, run_deep_dive, test_runner, run_zipcode_research, "
    "firestore_service) no longer exist on backend.main",
