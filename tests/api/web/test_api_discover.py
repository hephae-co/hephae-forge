...
async def client():
    ...
    with (
        patch("backend.routers.web.discover.InMemorySessionService", return_value=mock_session_svc),
        patch("backend.routers.web.discover.Runner", return_value=mock_runner),
        ...
        patch("backend.routers.web.discover.write_discovery", new_callable=AsyncMock, return_value=None) as mock_write_discovery,
