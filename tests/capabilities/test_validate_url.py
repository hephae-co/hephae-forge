...
from hephae_capabilities.shared_tools.validate_url import (
    validate_url,
    validate_urls_batch,
    _check_pattern,
    _http_check,
...
class TestHttpValidation:
    ...
    async def test_200_returns_valid(self):
        ...
        with patch("hephae_capabilities.shared_tools.validate_url.httpx.AsyncClient", return_value=client):
